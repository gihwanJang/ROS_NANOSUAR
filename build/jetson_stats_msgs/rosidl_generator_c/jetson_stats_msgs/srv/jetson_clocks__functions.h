...
#ifndef JETSON_STATS_MSGS__SRV__JETSON_CLOCKS__FUNCTIONS_H_
#define JETSON_STATS_MSGS__SRV__JETSON_CLOCKS__FUNCTIONS_H_
...
/// Initialize srv/JetsonClocks message.
/**
...
/// Finalize srv/JetsonClocks message.
/**
...
/// Create srv/JetsonClocks message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetson_stats_msgs__srv__JetsonClocks_Request__init().
...
/// Destroy srv/JetsonClocks message.
/**
 * It calls
 * jetson_stats_msgs__srv__JetsonClocks_Request__fini()
...
/// Initialize array of srv/JetsonClocks messages.
/**
...
/// Finalize array of srv/JetsonClocks messages.
/**
 * It calls
 * jetson_stats_msgs__srv__JetsonClocks_Request__fini()
...
/// Create array of srv/JetsonClocks messages.
/**
 * It allocates the memory for the array and calls
 * jetson_stats_msgs__srv__JetsonClocks_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/JetsonClocks messages.
/**
 * It calls
 * jetson_stats_msgs__srv__JetsonClocks_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetson_stats_msgs__srv__JetsonClocks_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetson_stats_msgs
...
/**
 * It calls
 * jetson_stats_msgs__srv__JetsonClocks_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetson_stats_msgs
...
/**
 * It allocates the memory for the array and calls
 * jetson_stats_msgs__srv__JetsonClocks_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetson_stats_msgs
...
/**
 * It calls
 * jetson_stats_msgs__srv__JetsonClocks_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JETSON_STATS_MSGS__SRV__JETSON_CLOCKS__FUNCTIONS_H_
