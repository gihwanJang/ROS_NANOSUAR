...
#include "nanosaur_msgs/srv/eye_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_EyeMessage_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_EyeMessage_Response(full_bounded, 0);
}
