...
#ifndef NANOSAUR_MSGS__MSG__EYES__STRUCT_HPP_
#define NANOSAUR_MSGS__MSG__EYES__STRUCT_HPP_
...
struct Eyes_
{
  ...
  explicit Eyes_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    position(_init)
  {
  ...
  explicit Eyes_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // NANOSAUR_MSGS__MSG__EYES__STRUCT_HPP_
