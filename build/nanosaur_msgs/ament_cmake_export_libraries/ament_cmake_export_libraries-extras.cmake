...
set(_exported_libraries "nanosaur_msgs__rosidl_typesupport_c;nanosaur_msgs__rosidl_typesupport_cpp;nanosaur_msgs__rosidl_typesupport_fastrtps_c;nanosaur_msgs__rosidl_generator_c;nanosaur_msgs__rosidl_typesupport_fastrtps_cpp;nanosaur_msgs__rosidl_typesupport_introspection_c;nanosaur_msgs__rosidl_typesupport_introspection_cpp")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'nanosaur_msgs' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND nanosaur_msgs_LIBRARIES ${_cfg} "${_lib}")
