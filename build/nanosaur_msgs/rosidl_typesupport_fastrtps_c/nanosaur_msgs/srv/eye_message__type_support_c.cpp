  ...
  void * untyped_ros_message)
{
  ...
  // Field name: message
  {
    ...
    if (ros_message->message.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->message);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->message, size)) {
      return "failed to create array for field 'message'";
    }
    auto array_ptr = ros_message->message.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
static size_t _EyeMessage_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nanosaur_msgs__srv__EyeMessage_Request(
    full_bounded, 0);
}
...
static size_t _EyeMessage_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_nanosaur_msgs__srv__EyeMessage_Response(
    full_bounded, 0);
}
